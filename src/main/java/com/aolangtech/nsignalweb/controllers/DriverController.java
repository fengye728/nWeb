...
import com.aolangtech.nsignalweb.Utils.XLSFileProcessUtil;
...
public class DriverController {
	...
	public DriverModel addDriver(@RequestBody DriverModel driver) throws NSException {
		if(1 == driverService.addWithDetail(driver)) {
			return driver;
		} else {
			throw new NSException("Add driver error");
		}
	}
